      ...
      <section className="py-20">  {/* Changed background color to dark */}
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto gap-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none sm:text-5xl xl:text-6xl text-white">
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-4 gap-3">
              ...
              <Link href="/write" className="inline-flex items-center justify-center w-full sm:w-auto px-5 py-3 text-base font-medium text-center text-gray-200 border border-gray-600 rounded-lg hover:bg-gray-700 focus:ring-4 focus:ring-gray-700 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                Write an Option
              </Link>
            </div>
          </div>
